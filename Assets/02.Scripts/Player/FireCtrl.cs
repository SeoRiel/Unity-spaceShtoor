...
[System.Serializable]
public struct PlayerSfx                                                  // 총알 발사 및 재장전 오디오 클립 저장에 필요한 구조체
{
...
public class FireCtrl : MonoBehaviour
{
    ...
    {
        if(Input.GetMouseButtonDown(0))      // 마우스 왼쪽 클릭 시, Fire 함수 호출
        {
            Fire();
        }
    }
    ...
    private void Fire()                                                  // Bullet Prefab 복제
    {

        Instantiate(bullet, firePos.position, firePos.rotation);   // Bullet Prefab 동적 생성
